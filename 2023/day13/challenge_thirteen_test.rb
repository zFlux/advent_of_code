...
class ChallengeThirteen_Objects < Minitest::Test
    ...
    def test_terrain_object4
        assert_equal 13, @terrain4.rows.length
        assert_equal 11, @terrain4.columns.length
        assert_equal 12, @terrain4.reflection_row
        assert_equal nil, @terrain4.reflection_column
        assert_equal 1200, @terrain4.reflection_number
        byebug
    end
end